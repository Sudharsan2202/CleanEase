          ...
          {currentUser ? (
            <>
              ...
              <div className="dropdown">
                ...
                <ul className="" aria-labelledby="navbarDropdownMenuAvatar">
                  <li><a className="dropdown" href="/profile">My profile</a></li>
                  
                  <li><a className="" href="/login" onClick={handleLogout}>Logout</a></li>
                </ul>
              </div>
            </>
          ) : (
